...
const tryAgain8tn = document.querySelector('.tryAgain-btn');
const goHome8tn = document.querySelector('.goHome-btn');
...
let progress = setInterval(() => {
  ...
  circularProgress.style.background = `conic-gradient(#b9681c ${progressStartValue * 3.6}deg, rgba(255, 255, 255, 0.24) 0deg)`;
